...
export interface ApiActionAction extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A tool action that can be executed via MCP';
    displayName: 'Action';
    pluralName: 'actions';
    singularName: 'action';
  };
  ...
  attributes: {
    ...
    api_config: Schema.Attribute.Component<'action.api-config', false>;
    auth_credential: Schema.Attribute.Relation<
      'manyToOne',
      'api::auth-credential.auth-credential'
    >;
    bash_config: Schema.Attribute.Component<'action.bash-config', false>;
    composite_config: Schema.Attribute.Component<
      'action.composite-config',
      false
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    parameters: Schema.Attribute.Component<'action.parameter', true>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiAuthCredentialAuthCredential
  extends Struct.CollectionTypeSchema {
  collectionName: 'auth_credentials';
  info: {
    description: 'Authentication credentials for API actions';
    displayName: 'Auth Credential';
    pluralName: 'auth-credentials';
    singularName: 'auth-credential';
  };
  options: {
    draftAndPublish: false;
  };
